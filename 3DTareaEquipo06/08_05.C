/* ejemplo 08_05.c, despliegue de objetos tridimensionales
   m‚todo de alambre, m‚todo de caras, representaci¢n isom‚trica */
...
int ORIGEN_X = 300;  /* origen del plano tridimensional     */
int ORIGEN_Y = 300;  /* con relaci¢n al plano bidimensional */

int ESCALA_X = 20;   /* escala absoluta de los v‚rtices tridimensionales */
int ESCALA_Y = 20;
